...
function getSpectators() {
  ...
  $.ajax({url: url, type: 'GET', async: false,
    success: function(response) {
      if (response.message.includes("0 spectators entries found")) {
...
function getPlayers() {
  ...
  $.ajax({url: url, type: 'GET', async: false,
    success: function(response) {
      if (response.message.includes("0 players entries found")) {
...
function getActiveGame() {
  ...
  $.ajax({url: url, type: 'GET', async: false,
    success: function(response) {
      if (response.message.includes("0 active_game entries found")) {
